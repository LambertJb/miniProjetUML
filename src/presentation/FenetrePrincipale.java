...
public class FenetrePrincipale extends JFrame implements ActionListener, WindowListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * tabProduits permet de tester le fonctionnement des fen�tres avec un
		 * tableau de noms de produits "en dur" Quand l'application
		 * fonctionnera, il faudra bien s�r r�cup�rer les noms des
